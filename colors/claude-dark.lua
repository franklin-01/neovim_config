...
local c = {
  bg           = "#161f1d",
  fg           = "#e6e6e6", -- plain identifiers/text
  keyword      = "#fca103", -- func, if, return, and builtin types (int, string, error)
  params       = "#83a8f2",
  ["function"] = "#0096fa", -- function/method names
  type         = "#b48cfa", -- qualified type names (pkg.Type)
  string       = "#32a852",
  number       = "#fa0a50", -- numbers AND nil share this pink/magenta
  punct        = "#a0a0a0", -- parens, braces, commas, operators
